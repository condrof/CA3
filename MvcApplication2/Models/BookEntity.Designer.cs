...
namespace MvcApplication2.Models
{
    ...
    /// </summary>
    public partial class BookEntityContainer : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new BookEntityContainer object using the connection string found in the 'BookEntityContainer' section of the application configuration file.
        /// </summary>
        public BookEntityContainer() : base("name=BookEntityContainer", "BookEntityContainer")
        {
        ...
        /// <summary>
        /// Initialize a new BookEntityContainer object.
        /// </summary>
        public BookEntityContainer(string connectionString) : base(connectionString, "BookEntityContainer")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new BookEntityContainer object.
        /// </summary>
        public BookEntityContainer(EntityConnection connection) : base(connection, "BookEntityContainer")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="BookEntity", Name="Book")]
    [Serializable()]
